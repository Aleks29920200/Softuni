...
import com.example.coffee_shop.entity.LoginUser;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public String loginPost(@Valid @ModelAttribute LoginUser loginDto, BindingResult result, RedirectAttributes attr) {
        if (result.hasErrors()) {
            attr
